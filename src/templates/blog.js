...
export default function Blog(props) {
  ...
  const authors = props.data.allAuthorsYaml.edges.map(edge => edge.node);
  const authorPath = data.frontmatter.author;
    ...
    <Layout>
      <article className={blogTemplateStyles.blog}>
        ...
        <div className={blogTemplateStyles.blog__footer}>
          {author ? <h2>Written By: {author.firstName}, {author.lastName}</h2> : null}
